...
BLOG_AUTHOR = "Ammiel Lopez"  # (translatable)
BLOG_TITLE = "Notas de Clases"  # (translatable)
...
BLOG_EMAIL = "ammiel.blog@gmail.com"
BLOG_DESCRIPTION = "Apuntes tomados de las clases en video de CarolinaU"  # (translatable)
...
FAVICONS = (
     ("icon", "/images/book-icon.png", "16x16"),
